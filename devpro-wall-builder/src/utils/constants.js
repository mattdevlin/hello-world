...
export const ROOF_SPLINE_EPS_DEPTH = 208;            // mm — long roof spline EPS (representative for display)
export const ROOF_SPLINE_SLABS_PER_BLOCK = 3;        // 208×3 = 624mm from 630
